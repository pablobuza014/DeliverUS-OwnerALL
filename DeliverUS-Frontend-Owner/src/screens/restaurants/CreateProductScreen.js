...
export default function CreateProductScreen ({ navigation, route }) {
  ...
  const initialProductValues = { name: null, highlight: false, promoted: false, Fats: 25.00, Proteins: 50.00, Carbohydrates: 25.00, description: null, price: null, order: null, restaurantId: route.params.id, productCategoryId: null, availability: true }
