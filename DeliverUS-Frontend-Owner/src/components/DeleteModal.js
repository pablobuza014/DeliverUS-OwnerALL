  ...
  return (
    ...
    <View style={styles.centeredView}>
      <View style={styles.modalView}>
        ...
        {props.children}
        <Pressable
          onPress={props.onCancel} // Función que se ejecutará para cancelar la operación.
          style={({ pressed }) => [
            {
        ...
        <Pressable
        onPress={props.onConfirm} // Función que se ejecutará para confirmar la operación.
        style={({ pressed }) => [
          {
            backgroundColor: pressed
